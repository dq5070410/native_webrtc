...
int32_t RTPSenderVideo::SendVideo(const RtpVideoCodecTypes videoType,
  ...
  printf("rtp_sender_video.cc fec_rete=%d,usd_uep=%d,max_fec_frames=%d,mask_type=%d\n",delta_fec_params_.fec_rate,delta_fec_params_.use_uep_protection,delta_fec_params_.max_fec_frames,delta_fec_params_.fec_mask_type);
