...
int32_t ViEEncoder::SendData(
  ...
  printf("vie_encoder.cc send data frame_type=%d,payload_type=%d,timestamp=%d,capture_time=%lld,size=%d\n",frame_type,payload_type,time_stamp,capture_time_ms,payload_size);
